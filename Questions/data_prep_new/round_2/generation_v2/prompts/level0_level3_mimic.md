...
Mimic target for this prompt: Level 3 style only.
- The question may sound interpretive, evaluative, or predictive.
- Keep it concise and reader-like; avoid pompous abstraction.
- It should feel like higher-level reasoning style, while still being a single clear question.

Critical distinction:
- STYLE should feel Level 3.
...
[
  {
    "reasoning": "English: explain why this is Level-0-unanswerable and why the wording mimics Level 3 style only.",
